...
function Application (options) {
  ...
  this.waitInterval = parseInt(options.waitInterval, 10) || 100
...
Application.prototype.stop = function () {
  ...
  return new Promise(function (resolve, reject) {
    ...
    self.client.windowByIndex(0).execute(function () {
      try {
        return devTools('electron').remote.app.quit()
      } catch (e) {
        window.close()
      }
...
Application.prototype.createClient = function () {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var options = {
      ...
      waitforInterval: self.waitInterval,
    ...
    options = Object.assign(options, this.overrides)
